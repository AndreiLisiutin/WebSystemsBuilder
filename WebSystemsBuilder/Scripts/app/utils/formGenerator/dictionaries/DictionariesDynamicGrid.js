Ext.define('WebSystemsBuilder.utils.formGenerator.dictionaries.DictionariesDynamicGrid', {
    requires: [
        'Ext.util.TextMetrics',
        'WebSystemsBuilder.utils.formGenerator.GeneratorModelsFactory'
    ],
    singleton: true,
    ...
    _getGridModelByDictionaryField: function (field) {
        var _this = this;
        var modelsFactory = WebSystemsBuilder.utils.formGenerator.GeneratorModelsFactory;
        var column = {
    ...
    _createDictionarySelectWindow: function (win, dictionaryID) {
        var grid_dictionary = WebSystemsBuilder.utils.formGenerator.dictionaries.DictionariesDynamicGrid.getGridPanel(win, dictionaryID, false);
