...
Ext.define('Actions', {
    singleton: true,
    requires: [
        'WebSystemsBuilder.utils.formGenerator.GeneratorFormFactory'
    ],
            ...
            case ActionKinds.OpenForm:
                ...
                if (properties && properties.length == 1 && properties[0].value > 0) {
                    ...
                    handler = function () {
                        ...
                        var formFactory = WebSystemsBuilder.utils.formGenerator.GeneratorFormFactory;
            ...
            case ActionKinds.CloseSuccessfull:
                ...
                handler = function () {
                    ...
                    win.OUT_PARAMETERS.forEach(function (param) {
                        var control = WebSystemsBuilder.utils.formGenerator.GeneratorFormFactory.getControlByID(win, param.controlID);
                        out.push({
                            name: param.name,
    ...
    saveFormDictionary: function (control) {
        var formsFactory = WebSystemsBuilder.utils.formGenerator.GeneratorFormFactory;
        var win = control.up('window');
        if (!win.DICTIONARY) {
